...
const ImgComp = <T extends BaseElement>({ element, type }: { element: T, type?: string }) => {
  ...
  return (
    ...
    <div className={`${type!='dest' ? 'relative max-h-[340px]  min-h-[340px] md:max-h-[560px] md:min-h-[560px] lg:max-h-[660px] lg:min-h-[660px] overflow-hidden pt-[125%] lg:pt-[122%]' : 'py-6 md:py-10 lg:py-0 px-7'}  flex justify-center items-center xl:items-start xl:justify-start `}
    >
